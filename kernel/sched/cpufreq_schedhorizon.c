...
static unsigned int default_efficient_freq_lp[] = {883200,1075200,1516800};
static u64 default_up_delay_lp[] = {150 * NSEC_PER_MSEC,150 * NSEC_PER_MSEC,150 * NSEC_PER_MSEC};


static unsigned int default_efficient_freq_hp[] = {710400,1478400,2054400};
static u64 default_up_delay_hp[] = {150 * NSEC_PER_MSEC, 150 * NSEC_PER_MSEC, 150 * NSEC_PER_MSEC};
...
#define DEFAULT_HISPEED_LOAD_LP 60
#define DEFAULT_HISPEED_LOAD_HP 50
#define DEFAULT_HISPEED_LOAD_PR 90

#define DEFAULT_HISPEED_FREQ_LP 883200
