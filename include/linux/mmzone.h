 ...
 * generation. The gen counter in page->flags stores gen1 while a page is on
 ...
 * page tables. It requires order_base_2(MAX_NR_GENS1) bits in page->flags.
 */
 ...
 * comparisons of refaulted/(evictedprotected) from the first tier and the
